...
function Footer() {
  return (
    <footer className="bg-gray-50 flex flex-col lg:grid lg:grid-cols-5 mt-4 px-4 py-6 sm:py-10">
      <div className="lg:col-span-2 flex flex-col items-left pl-4 sm:pl-8">
        <div className="text-gray-700 text-sm">
          ...
          <p className="mt-2 sm:mt-4 text-xs sm:text-sm">
            Digital Fortress Private Limited offers a secure and convenient passwordless<br /> authentication solution
          </p>
        </div>
        <div className="flex mt-5 space-x-4">
          ...
          <a href="https://www.linkedin.com/company/digital-fortress-private-limited/" className="text-gray-500 hover:text-gray-800 transition flex items-center">
            <img src="https://www.linkedin.com/favicon.ico" alt="LinkedIn" className="w-4 h-4 mr-1" />
            LinkedIn
          </a>
      ...
      <div className="lg:col-span-3 px-4 py-4 sm:px-6 lg:px-8">
        <FadeIn>
          {/* <div className="grid grid-cols-1 gap-8 sm:gap-16 lg:grid-cols-2"> */}
            {/* <Navigation /> */}
            <div className="flex justify-right sm:justify-end">
              <NewsletterForm />
            </div>
          {/* </div> */}
        </FadeIn>
